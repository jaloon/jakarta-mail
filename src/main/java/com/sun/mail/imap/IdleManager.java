...
public class IdleManager {
    ...
    private final Queue<IMAPFolder> toWatch = new ConcurrentLinkedQueue<>();
    private final Queue<IMAPFolder> toAbort = new ConcurrentLinkedQueue<>();
     ...
     * @throws IOException for Selector failures
     */
    ...
    private static String folderName(Folder folder) {
        try {
            ...
            // can't happen
            return folder.getStore().toString() + "/" + folder;
        }
    }
     ...
     * @throws MessagingException for errors related to the folder
     */
