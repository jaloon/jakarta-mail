...
public class POP3Folder extends Folder {
     ...
     *
     * @throws FolderNotFoundException       if not INBOX
     * @throws AuthenticationFailedException authentication failures
     * @throws MessagingException            other open failures
     */
    @Override
     ...
     * @throws IllegalStateException if the folder isn't open
     * @throws IOException           for I/O errors talking to the server
     * @throws MessagingException    for other errors
     * @since JavaMail 1.3.3
     */
